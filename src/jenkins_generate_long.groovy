...
job('GCS-CI-CD/TestsLong/126') {
   ...
   steps {
      shell('ssh tstusr@h007 /tools/CS/bin/gcs-ci-cd ${CLUSTER} check /home/tstusr/CS/gcs-ci-cd-0/testsuite/src/checktree/bugs/issuezilla/126 200')
   }
}
queue('GCS-CI-CD/TestsLong/126')
